(function (angular) {
    ...
    angular.module("app")
        .directive("viewInvocieDirective", ['$state', '$timeout', '$q', '$filter', '$window', 'DataService', 'notify', 'Session', function (state, timeout, $q, $filter, $window, DataService, notify, Session) {

            return {

                templateUrl: currentScriptPath.replace('viewInvocie.js', 'viewInvocie.html'),
